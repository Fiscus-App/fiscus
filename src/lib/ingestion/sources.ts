...
export const SOURCES: SourceDefinition[] = [
  ...
  // ── Australian Financial Specialists ────────────────────────────────────────
  {
    ...
    rssUrl: 'https://www.afr.com/rss/markets',
    type: 'RSS_FEED',
    credibility: 'TIER_1_MEDIA',
    sector: null,
    maxItems: 20,
  },
  {
    ...
    rssUrl: 'https://www.afr.com/rss/companies',
    type: 'RSS_FEED',
    credibility: 'TIER_1_MEDIA',
    sector: null,
    maxItems: 15,
  ...
  {
    id: 'the-australian-business',
    name: 'The Australian — Business',
    url: 'https://www.theaustralian.com.au/business',
    rssUrl: 'https://www.theaustralian.com.au/feed?categories=business',
    type: 'RSS_FEED',
    credibility: 'TIER_1_MEDIA',
    sector: null,
    maxItems: 15,
  },
  {
    ...
    rssUrl: 'https://stockhead.com.au/feed/',
    type: 'RSS_FEED',
    credibility: 'OTHER',
    sector: null,
    maxItems: 20,
  },
  {
    ...
    rssUrl: 'https://www.livewiremarkets.com/feeds/rss',
    type: 'RSS_FEED',
    credibility: 'OTHER',
    sector: null,
    maxItems: 15,
  },
  {
    ...
    rssUrl: 'https://www.fool.com.au/feed/',
    type: 'RSS_FEED',
    credibility: 'OTHER',
    sector: null,
    maxItems: 15,
  },
  {
    ...
    rssUrl: 'https://www.investsmart.com.au/rss/news.rss',
    type: 'RSS_FEED',
    credibility: 'OTHER',
    sector: null,
    maxItems: 10,
  },
  {
    ...
    rssUrl: 'https://www.marketindex.com.au/rss/news',
    type: 'RSS_FEED',
  ...
  },
  {
    ...
    rssUrl: 'https://ausbiz.com.au/feed/',
    type: 'RSS_FEED',
    credibility: 'OTHER',
    sector: null,
    maxItems: 10,
  ...
  // ── Market Data & Financial News ─────────────────────────────────────────────
  {
    ...
    rssUrl: 'https://au.finance.yahoo.com/news/rssindex',
    type: 'RSS_FEED',
    credibility: 'MARKET_DATA',
    sector: null,
    maxItems: 15,
  ...
  // ── Australian Treasury / Government ────────────────────────────────────────
  {
    id: 'aus-treasury',
    name: 'Australian Treasury',
    url: 'https://treasury.gov.au',
    rssUrl: 'https://treasury.gov.au/rss.xml',
    type: 'RSS_FEED',
    credibility: 'OFFICIAL',
    sector: 'Macroeconomics',
    maxItems: 5,
